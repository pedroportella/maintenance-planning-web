...
The mock end-to-end smoke starts the workbench locally, verifies the planner shell, opens the recommendation workbench, records a mock planner decision, then checks planning-run detail and backlog state.

The services package check verifies runtime mode selection, deterministic synthetic fixtures, mock decision recording and backend adapter calls against typed contracts.
